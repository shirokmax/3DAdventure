...
namespace SimpleFPS
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float painSoundDelay = 1f;
        private float painSoundTimer;
        ...
        private void Start()
        {
            ...
            destructible.TakeDamage.AddListener(OnTakeDamage);
            painSoundTimer = painSoundDelay;
        ...
        {
            destructible.TakeDamage.RemoveListener(OnTakeDamage);
        }


        private void OnTakeDamage()
        {
            if (painSoundTimer >= painSoundDelay)
            {
                m_AudioSource.clip = painSounds[rnd.Next(0, painSounds.Length)];
                m_AudioSource.Play();
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (damageZone != null) isInDamageZone = true;
        }
        ...
        private void OnTriggerExit(Collider other)
        {
            ...
            if (damageZone != null) isInDamageZone = false;
        }

        // Update is called once per frame
        private void Update()
        {
            painSoundTimer += Time.deltaTime;
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded)
            {
                ...
                if (m_Jump)
                {
                    ...
                    if (isInDamageZone == false) PlayJumpSound();
                    m_Jump = false;
                    m_Jumping = true;
                }
            }
        ...
        private void ProgressStepCycle(float speed)
        {
            ...
            if (isInDamageZone == false) PlayFootStepAudio();
        }
